...
public class Soundcapture extends JPanel implements ActionListener {
  ...
  public Soundcapture(File myfile) {
  ...
  class Capture implements Runnable {
    ...
    fos = new FileOutputStream (new File(file+".WAV"));
    out.writeTo(fos);
    while (thread != null) {
        if ((numBytesRead = line.read(data, 0, bufferLengthInBytes)) == -1) {
          break;
    ...
    System.out.println("oooooooooooo");
       ...
       AudioSystem.write(audioInputStream ,AudioFileFormat.Type.WAVE, new File(file+".mp3"));
       z++;
